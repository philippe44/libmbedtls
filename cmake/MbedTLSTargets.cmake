...
cmake_path(GET CMAKE_CURRENT_LIST_DIR PARENT_PATH LIBMBEDTLS_DIR)
set(LIBMBEDTLS_DIR "${LIBMBEDTLS_DIR}/targets")
message(STATUS "Using MbedTLS in ${LIBMBEDTLS_DIR}/${HOST}/${PLATFORM}")
...
set_target_properties(MbedTLS::mbedcrypto PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${LIBMBEDTLS_DIR}/include/"
)
...
set_target_properties(MbedTLS::mbedcrypto PROPERTIES
  ...
  IMPORTED_LOCATION_NOCONFIG "${LIBMBEDTLS_DIR}/${HOST}/${PLATFORM}/libmbedcrypto.a"
  )
...
set_target_properties(MbedTLS::mbedx509 PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_NOCONFIG "C"
  IMPORTED_LOCATION_NOCONFIG "${LIBMBEDTLS_DIR}/${HOST}/${PLATFORM}/libmbedx509.a"
  )
...
set_target_properties(MbedTLS::mbedtls PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_NOCONFIG "C"
  IMPORTED_LOCATION_NOCONFIG "${LIBMBEDTLS_DIR}/${HOST}/${PLATFORM}/libmbedtls.a"
  )
